...
fun ScoreboardScreen(
    ...
    //Baggrunden
    {
        ...
        Column() {
            val scoreboardClasses =
                classList.map { it.className } //Her oprettes en ny liste ud fra classList bare kun med className
...
@Composable
fun Scoreboard(
    scoreboardClasses: List<String>,
    scoreboardScores: List<Int>
) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Column(
            ...
            {
                scoreboardClasses.zip(scoreboardScores)
                    .forEach { (scoreboardClass, scoreBoardScore) ->
                        TextFontGaming(
                            textInput = "$scoreboardClass $scoreBoardScore",
                            fontSizeInput = 12
                        )
                    }
            }
